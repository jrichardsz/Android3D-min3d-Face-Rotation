...
public class ExampleAccelerometer extends RendererActivity implements SensorEventListener {
    ...
    public void initScene()
    {
       ...
       mSkyBox.addTexture(SkyBox.Face.North,   R.mipmap.ic_launcher,   "north");
        mSkyBox.addTexture(SkyBox.Face.East,   R.mipmap.ic_launcher,   "east");
      ...
      /* IParser parser = Parser.createParser(Parser.Type.MAX_3DS,
                getResources(), R.raw.face_obj, getPackageName(), true);
        parser.parse();
